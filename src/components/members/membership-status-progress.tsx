        ...
        <CardContent className="space-y-6">
          <Alert>
            ...
            <AlertDescription className="text-base">
              No membership record found. Please complete your registration to track your
              application status.
            </AlertDescription>
          </Alert>
        </CardContent>
        ...
        {status === 'rejected' ? (
          <div className="space-y-6">
            <Alert variant="destructive">
              ...
              <AlertDescription className="text-base">
                {STATUS_CONFIG.rejected.description}. You may submit a new application or contact
